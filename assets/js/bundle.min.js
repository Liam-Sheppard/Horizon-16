...
var gradFilter=new GraduatesFilter('.graduate-filters-container');});})(jQuery);(function($){$(document).ready(function(){function initialiseWorkPage(workContentContainer){this.workContent=$(workContentContainer).find('.work-content');workContentContainer.find('.work-carousel').slick({infinite:false,autoplay:true,arrows:false,});this.workContent.addClass('loaded');}
