...
var $scrollBasedAnimates=$('.panel-bridge, .horizon-rule, h2');watchSeen($scrollBasedAnimates);$(window).scroll(function(){watchSeen($scrollBasedAnimates);});console.log(siteData.graduates.length);console.log(siteData.graduates);});
