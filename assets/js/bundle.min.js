...
return true;}
$(document).ready(function(){$('body').addClass('loaded');function Polygon(svg){this.arm={node:svg.find('polyline.a'),points:[],};this.reflection={node:svg.find('polyline.b'),points:[],};this.a.points=svg.find('polyline.a').attr('points').split(' ');this.b.points=svg.find('polyline.b').attr('points').split(' ');}
...
var $scrollBasedAnimates=$('.panel-bridge, .horizon-rule, h2');watchSeen($scrollBasedAnimates);$(window).scroll(function(){watchSeen($scrollBasedAnimates);});console.log(siteData.graduates.length);console.log(siteData.graduates);var position,direction,previous,scrollBottom;$(window).scroll(function(){scrollBottom=$(this).scrollTop()+$(this).height();if(position<=50){$('#workJS').removeClass('work-show');$('#leftPanelJS').removeClass('work-show');}else{$('#workJS').addClass('work-show');$('#leftPanelJS').addClass('work-show');}
