...
return true;}
$(document).ready(function(){$('body').addClass('loaded');var navInTransition=false;$('.toggle-mobile-menu').click(function(e){if(!navInTransition){navInTransition=!navInTransition;if(!$('body').hasClass('show-mobile-menu')){$('#primary-navigation-menu').show();setTimeout(function(){$('body').addClass('show-mobile-menu');navInTransition=!navInTransition;},50);}else{$('body').removeClass('show-mobile-menu');setTimeout(function(){$('#primary-navigation-menu').hide();navInTransition=!navInTransition;},400);}}});function Polygon(svg){this.arm={node:svg.find('polyline.a'),points:[],};this.reflection={node:svg.find('polyline.b'),points:[],};this.a.points=svg.find('polyline.a').attr('points').split(' ');this.b.points=svg.find('polyline.b').attr('points').split(' ');}
