...
var $scrollBasedAnimates=$('.panel-bridge, .horizon-rule, h2, .next-graduate');watchSeen($scrollBasedAnimates);$(window).scroll(function(){watchSeen($scrollBasedAnimates);});var position;$(window).scroll(function(){position=$(this).scrollTop();if(position<=50){$('#workJS').removeClass('work-show');$('#leftPanelJS').removeClass('work-show');}else{$('#workJS').addClass('work-show');$('#leftPanelJS').addClass('work-show');}});});
