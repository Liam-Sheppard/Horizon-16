...
function enqueue_scripts_and_styles(){
  ...
  wp_register_script('bundled-js', get_stylesheet_directory_uri() . '/assets/js/bundle.min.js', [], 1.4, true);
  wp_localize_script('bundled-js', 'siteData', [
    'homeUrl' => get_home_url(),
    'themeUri' => get_stylesheet_directory_uri(),
    'graduates' => get_graduates(get_graduate_ids(true)),
  ]);
  wp_enqueue_style('styles', get_stylesheet_directory_uri(). '/assets/css/styles.min.css', [], 1.4, 'screen');
